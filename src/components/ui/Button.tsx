...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "text-on-accent bg-background-ui border-background-ui hover:bg-background-ui-hover hover:border-background-ui-hover active:bg-background-ui-active active:border-background-ui-active focus-visible:ring-2 focus-visible:ring-text focus-visible:ring-offset-2 focus-visible:ring-offset-background",
    "primary-soft":
