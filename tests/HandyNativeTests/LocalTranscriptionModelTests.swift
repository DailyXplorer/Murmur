...
final class LocalTranscriptionModelTests: XCTestCase {
    func testLocalCatalogKeepsHandyWhisperIDsSelectable() {
    ...
    func testTurboMatchesCurrentHandyTranslationContract() {
        var settings = AppSettings.defaults
    ...
    private func makeTemporaryStoragePaths() throws -> AppPaths {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("HandyNativeModelStorage-\(UUID().uuidString)", isDirectory: true)
