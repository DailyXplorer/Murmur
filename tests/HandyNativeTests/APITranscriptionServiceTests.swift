...
final class APITranscriptionServiceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        temporaryDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("HandyNativeAPITranscription-\(UUID().uuidString)", isDirectory: true)
    ...
    func testAudioTranscriptionEndpointSendsMultipartRequest() async throws {
        ...
        APITranscriptionURLProtocolStub.handler = { request in
            ...
            XCTAssertTrue(request.value(forHTTPHeaderField: "Content-Type")?.hasPrefix("multipart/form-data; boundary=handy-api-transcription-") == true)
    ...
    private func writeAudioFixture() throws -> URL {
        ...
        try Data("RIFFhandyWAVE".utf8).write(to: url)
        return url
    }
