...
struct AppPaths {
    static let sharedAppDataIdentifier = "com.pais.murmur"
    static let portableMarkerContents = "Murmur Portable Mode"
    ...
    static func resolve() throws -> AppPaths {
        ...
        if let appDataOverride = ProcessInfo.processInfo.environment["MURMUR_APP_DATA_DIR"]?
